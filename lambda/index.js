...
function handleUserGuess(userGaveUp, handlerInput) {
  ...
  if (answerSlotValid
    ...
    notifier.notify('correct', currentScore);
  } else {
    if (!userGaveUp) {
    ...
    notifier.notify('incorrect', currentScore);
  }
  ...
  if (sessionAttributes.currentQuestionIndex === GAME_LENGTH - 1) {
    ...
    notifier.notify('end', currentScore);
...
const languageString = {
  de: {
    translation: {
      ...
      GAME_NAME: 'Wissenswertes über <emphasis level="strong">die SUVA</emphasis> ',
      ...
      ASK_MESSAGE_START: 'Möchtest du jetzt beginnen?',
      ...
      SCORE_IS_MESSAGE: 'Aktueller Punktestand: <say-as interpret-as="cardinal">%s</say-as>. '
    },
  },
};
